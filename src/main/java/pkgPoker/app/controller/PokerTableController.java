...
//					 pntCardDealt, img);
				...
				Path path = new Path();
				MoveTo move = new MoveTo(pntDeck.getX(),pntDeck.getY());
				CubicCurveTo curve = new CubicCurveTo(175,250,pntDeck.getX(),pntDeck.getY(), pntCardDealt.getX(), pntCardDealt.getY());
